class LakerunnerCli < Formula
  ...
  if OS.mac?
    if Hardware::CPU.intel?
      url "https://github.com/cardinalhq/lakerunner-cli/releases/download/v1.0.0/lakerunner-cli_Darwin_x86_64.tar.gz"
      sha256 "59269fb9f607eca7155666754aa8341a4bc9cfbd467a088ee367fb7f0ef1073c"
    else
      url "https://github.com/cardinalhq/lakerunner-cli/releases/download/v1.0.0/lakerunner-cli_Darwin_arm64.tar.gz"
      sha256 "90bbf852183dfc6f3988104fe1a82404063fe6c54290cd293080cac8acfb114d"
    end
  elsif OS.linux?
    if Hardware::CPU.intel?
      url "https://github.com/cardinalhq/lakerunner-cli/releases/download/v1.0.0/lakerunner-cli_Linux_x86_64.tar.gz"
      sha256 "229634671c5dc63a95b25ddeb492166d125963761017135382e49a082886c05f"
    else
      url "https://github.com/cardinalhq/lakerunner-cli/releases/download/v1.0.0/lakerunner-cli_Linux_arm64.tar.gz"
